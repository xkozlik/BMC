...
The distance between two configurations $q,q' \in \C$ is measured using these atoms positions:

\begin{equation}
\dist(q_a,q_b) = \sum_{i=0}^n dist_e(a_i(q),a_i(q'))
\end{equation}

\noindent
where $n$ is the number of atoms of the ligand, and $dist_e$ is the 3D Euclidean metric.
